...
# Copied from https://github.com/mebeim/aoc/blob/master/2020/solutions/day20.py
...
def setup(year, day):
    ...
    if not (year >= 2015 and 1 <= day <= 25):
        print('ERROR: invalid year and/or day set!\n')
        sys.exit(1)
